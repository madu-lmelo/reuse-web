...
function writeUserDataInstituicao(uid, nomeFantasia, email, telefone, senha, nomeUsuario, cnpj) {
...
submit.addEventListener('click', (e) => {
    ...
    createUserWithEmailAndPassword(auth, email, senha)
        .then(userCredential => {
            ...
            return writeUserDataInstituicao(user.uid, nomeFantasia, email, telefone, senha, nomeUsuario, cnpj);
        })
